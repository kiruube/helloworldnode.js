    // Form validation
    const form = document.getElementById('daycareApplicationForm');
    ...
    function validateForm() {
        ...
        if (childName === '') {
            document.getElementById('childNameError').textContent = 'Child\'s name is required';
            isValid = false;
        }
        ...
        if (fatherPhone === '') {
            document.getElementById('fatherPhoneError').textContent = 'Father\'s phone number is required';
            isValid = false;
        }

        const fatherEmail = form.elements['fatherEmail'].value.trim();
        if (fatherEmail === '') {
            document.getElementById('fatherEmailError').textContent = 'Father\'s email is required';
            isValid = false;
        }

        const fatherNationality = form.elements['fatherNationality'].value.trim();
        if (fatherNationality === '') {
            document.getElementById('fatherNationalityError').textContent = 'Father\'s nationality is required';
            isValid = false;
        }

        const fatherOccupation = form.elements['fatherOccupation'].value.trim();
        if (fatherOccupation === '') {
            document.getElementById('fatherOccupationError').textContent = 'Father\'s occupation is required';
            isValid = false;
        }
        ...
        if (motherPhone === '') {
            document.getElementById('motherPhoneError').textContent = 'Mother\'s phone number is required';
            isValid = false;
        }

        const motherEmail = form.elements['motherEmail'].value.trim();
        if (motherEmail === '') {
            document.getElementById('motherEmailError').textContent = 'Mother\'s email is required';
            isValid = false;
        }

        const motherNationality = form.elements['motherNationality'].value.trim();
        if (motherNationality === '') {
            document.getElementById('motherNationalityError').textContent = 'Mother\'s nationality is required';
            isValid = false;
        }

        const motherOccupation = form.elements['motherOccupation'].value.trim();
        if (motherOccupation === '') {
            document.getElementById('motherOccupationError').textContent = 'Mother\'s occupation is required';
            isValid = false;
        }
        ...
        const medicalBackground = form.elements['medicalBackground'].value.trim();
        if (medicalBackground === '') {
            document.getElementById('medicalBackgroundError').textContent = 'Medical background is required';
            isValid = false;
        }
        ...
        if (isOrphanYes.checked) {
            ...
            if (guardianName === '') {
                document.getElementById('guardianNameError').textContent = 'Guardian\'s name is required';
                isValid = false;
            }

            const guardianPhone = form.elements['guardianPhone'].value.trim();
            if (guardianPhone === '') {
                document.getElementById('guardianPhoneError').textContent = 'Guardian\'s phone number is required';
                isValid = false;
            }

            const guardianEmail = form.elements['guardianEmail'].value.trim();
            if (guardianEmail === '') {
                document.getElementById('guardianEmailError').textContent = 'Guardian\'s email is required';
                isValid = false;
            }

            const relationshipStatus = form.elements['relationshipStatus'].value.trim();
            if (relationshipStatus === '') {
                document.getElementById('relationshipStatusError').textContent = 'Relationship status with the child is required';
                isValid = false;
            }
        }
